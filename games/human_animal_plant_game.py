...
from games.game_helpers import create_game_header, create_progress_box, create_separator, create_action_buttons, create_winner_card
...
class HumanAnimalPlantGame:
        ...
        contents = [
            ...
            create_separator(),
            {
                ...
                "contents": [
                    ...
                    {"type": "text", "text": "اكتب 4 كلمات تبدأ بهذا الحرف", "size": "sm", "color": COLORS['text_dark'], "margin": "md", "wrap": True, "align": "center"},
                    {"type": "text", "text": "كل كلمة في سطر منفصل", "size": "xs", "color": COLORS['text_light'], "margin": "xs", "align": "center"}
                ],
                "margin": "lg"
            },
            create_separator(),
    ...
    def _end_game(self):
        ...
        winner_card_dict = create_winner_card(winner, sorted_players, "لعبه")
