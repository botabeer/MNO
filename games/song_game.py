...
class SongGame:
    def __init__(self, line_bot_api):
        ...
        self.songs = [
            ...
            {"lyrics": "انا بلياك اذا ارمش الك تنزل الف دمعه", "singer": "ماجد المهندس"},
            {"lyrics": "يا بعدهم كلهم يا سراجي بينهم", "singer": "عبدالمجيد عبدالله"},
            {"lyrics": "جنّنت قلبي بحب يلوي ذراعي", "singer": "ماجد المهندس"},
            {"lyrics": "واسع خيالك اكتبه انا بكذبك معجبه", "singer": "شمة حمدان"},
            {"lyrics": "خذني من ليلي لليلك", "singer": "عبادي الجوهر"},
            {"lyrics": "انا عندي قلب واحد", "singer": "حسين الجسمي"},
            {"lyrics": "اريد الله يسامحني لان اذيت نفسي", "singer": "رحمة رياض"}
        ]
        self.questions = []
        ...
        return FlexSendMessage(
            ...
            contents={
                ...
                "body": {
                    ...
                    "layout": "vertical",
                    "contents": [
                        {"type": "box", "layout": "vertical", "contents": [{"type": "text", "text": "لعبة الأغنية", "weight": "bold", "size": "xl", "color": COLORS['white']}], "backgroundColor": COLORS['primary'], "paddingAll": "20px", "cornerRadius": "10px"},
                        {"type": "box", "layout": "vertical", "contents": [{"type": "text", "text": f"السؤال {self.current_question + 1} من {self.total_questions}", "size": "sm", "color": COLORS['text_light']}, {"type": "text", "text": song['lyrics'], "size": "lg", "color": COLORS['text_dark'], "wrap": True, "margin": "md"}, {"type": "text", "text": "من المغني", "size": "md", "color": COLORS['primary'], "weight": "bold", "margin": "md"}], "margin": "lg", "spacing": "sm"},
