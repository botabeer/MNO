...
class FastTypingGame:
    def __init__(self, line_bot_api):
        ...
        self.words = ["سرعة", "كتابة", "برمجة", "حاسوب", "إنترنت", "تطبيق", "موقع", "شبكة", "تقنية", "ذكاء", "استغفر الله", "تطوير", "مبرمج", "لغة", "كود", "برنامج", "نظام", "بيانات", "معلومات", "أمان"]
        self.questions = []
        ...
        return FlexSendMessage(
            ...
            contents={
                ...
                "body": {
                    ...
                    "layout": "vertical",
                    "contents": [
                        {"type": "box", "layout": "vertical", "contents": [{"type": "text", "text": "الكتابة السريعة", "weight": "bold", "size": "xl", "color": COLORS['white']}], "backgroundColor": COLORS['primary'], "paddingAll": "20px", "cornerRadius": "10px"},
                        {"type": "box", "layout": "vertical", "contents": [{"type": "text", "text": f"جولة {self.current_question + 1} من {self.total_questions}", "size": "sm", "color": COLORS['text_light']}, {"type": "text", "text": word, "size": "xxl", "color": COLORS['primary'], "weight": "bold", "margin": "md", "align": "center"}, {"type": "text", "text": "اكتب الكلمة بأسرع وقت", "size": "sm", "color": COLORS['text_dark'], "margin": "md", "align": "center"}, {"type": "text", "text": f"لديك {self.time_limit} ثانية", "size": "xs", "color": COLORS['text_light'], "margin": "xs", "align": "center"}], "margin": "lg", "spacing": "sm"}
                    ],
