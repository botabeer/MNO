            ...
            contents={
                ...
                "body": {
                    ...
                    "contents": [
                        ...
                        {"type": "box", "layout": "vertical", "contents": [{"type": "text", "text": "امثلة", "size": "sm", "color": COLORS['text_light'], "weight": "bold"}, {"type": "text", "text": "الحوت و القوس", "size": "sm", "color": COLORS['text_light'], "margin": "sm"}, {"type": "text", "text": "الحوت و عبير", "size": "sm", "color": COLORS['text_light'], "margin": "xs"}], "margin": "lg"}
                    ],
            ...
            contents={
                ...
                "body": {
                    ...
                    "contents": [
                        ...
                        {"type": "separator", "margin": "lg", "color": COLORS['border']},
                        {"type": "box", "layout": "vertical", "contents": [{"type": "text", "text": "نفس النتيجة تظهر دائما لنفس الاسماء", "size": "xs", "color": COLORS['text_light'], "align": "center", "wrap": True}], "margin": "md"},
                        {"type": "box", "layout": "horizontal", "contents": [{"type": "button", "action": {"type": "message", "label": "اعادة", "text": "توافق"}, "style": "primary", "color": COLORS['primary'], "height": "sm", "flex": 1}, {"type": "button", "action": {"type": "message", "label": "بداية", "text": "بداية"}, "style": "secondary", "height": "sm", "flex": 1}], "spacing": "sm", "margin": "lg"}
                    ],
                    "backgroundColor": COLORS['card_bg'],
                    "paddingAll": "20px"
                }
