...
class MafiaGame:
    """
    لعبة المافيا المبسطة
    - واجهة واضحة للمبتدئين
    - شرح مفصل لكل مرحلة
    ...
    def explanation_flex(self):
        """شرح اللعبة للمبتدئين"""
        sections = [
            {
                "title": "الخطوة 1: التسجيل",
                "text": "اضغط 'انضم مافيا' في المجموعة"
            },
            {
                "title": "الخطوة 2: البدء",
                "text": "عند اكتمال العدد، اضغط 'بدء مافيا'"
            },
            {
                "title": "الخطوة 3: الدور",
                "text": "ستصلك رسالة خاصة بدورك في اللعبة"
            },
            {
                "title": "الليل - في الخاص",
                "text": "المافيا: اقتل اسم\nالمحقق: افحص اسم\nالدكتور: احمي اسم"
            },
            {
                "title": "النهار - في المجموعة",
                "text": "ناقش ثم اكتب 'تصويت مافيا'\nثم 'صوت اسم' للتصويت\nثم 'إنهاء التصويت'"
            },
            {
                "title": "الفوز",
                "text": "المافيا تفوز إذا ساوت عدد المواطنين\nالمواطنون يفوزون إذا قتلوا المافيا"
            }
        ]
        ...
        if len(self.players) < MAFIA_CONFIG["min_players"]:
            return {
                "response": TextMessage(
                    text=f"عدد اللاعبين غير كافٍ. الحد الأدنى {MAFIA_CONFIG['min_players']} لاعبين"
                )
            }
            ...
            contents=FlexContainer.from_dict({
                ...
                "body": {
                    ...
                    "contents": [
                        ...
                        {
                            "type": "text",
                            "text": f"اللاعبون الأحياء: {alive_count}",
                            "size": "sm",
                            "color": COLORS['text_light'],
                            "align": "center",
                            "margin": "md"
                        ...
                        },
                        {
                            ...
                            "action": {
                                "type": "message",
                                "label": "إنهاء الليل والانتقال للنهار",
                                "text": "إنهاء الليل"
                            },
                            "style": "primary",
                            "color": COLORS['primary'],
    ...
    def process_night(self):
        ...
        return {
            "response": [TextMessage(text=m) for m in msgs] + [self._day_flex()]
        }
    ...
    def end_voting(self):
        ...
        if not self.votes:
            ...
            return {
                "response": [
                    TextMessage(text="لم يتم التصويت. الانتقال لليل"),
                    self._night_flex()
                ]
            }
...
startswith("صوت "):
        ...
        # Role-specific night actions (in private)
