        ...
        return {
            ...
            "body": {
                ...
                "contents": [
                    ...
                    {"type": "box", "layout": "vertical", "contents": [{"type": "text", "text": "تم إنشاء هذا البوت بواسطة", "size": "xxs", "color": COLORS['text_light'], "align": "center"}, {"type": "text", "text": "عبير الدوسري © 2025", "size": "xs", "color": COLORS['text_light'], "align": "center", "weight": "bold", "margin": "xs"}], "margin": "md"}
                ],
        ...
        return {
            ...
            "body": {
                ...
                "contents": [
                    ...
                    {"type": "separator", "margin": "md", "color": COLORS['border']},
                    {"type": "box", "layout": "vertical", "contents": [{"type": "text", "text": "تم إنشاء هذا البوت بواسطة", "size": "xxs", "color": COLORS['text_light'], "align": "center"}, {"type": "text", "text": "عبير الدوسري © 2025", "size": "xs", "color": COLORS['text_light'], "align": "center", "weight": "bold", "margin": "xs"}], "margin": "xs"}
                ],
                "backgroundColor": COLORS['card_bg'],
                "paddingAll": "20px"
            }
