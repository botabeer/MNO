        ...
        return {
            ...
            "body": {
                ...
                "contents": [
                    ...
                    {"type": "separator", "margin": "md", "color": COLORS['border']},
                    {"type": "box", "layout": "vertical", "contents": [{"type": "text", "text": "التسجيل وتغيير الاسم", "size": "md", "color": COLORS['success'], "weight": "bold"}, {"type": "text", "text": "اكتب تسجيل لتحسب إجابتك و انسحب لعدم رد البوت عليك", "size": "xs", "color": COLORS['text_light'], "margin": "sm", "wrap": True}], "margin": "md"},
                    {"type": "separator", "margin": "md", "color": COLORS['border']},
                    ...
                    {"type": "separator", "margin": "md", "color": COLORS['border']},
                    {"type": "box", "layout": "vertical", "contents": [{"type": "text", "text": "الالعاب", "size": "md", "color": COLORS['primary'], "weight": "bold"}, {"type": "text", "text": "فئة اغنية ضد تكوين سلسلة اسرع لعبة", "size": "sm", "color": COLORS['text_light'], "margin": "sm", "wrap": True}], "margin": "md"},
                    {"type": "separator", "margin": "md", "color": COLORS['border']},
